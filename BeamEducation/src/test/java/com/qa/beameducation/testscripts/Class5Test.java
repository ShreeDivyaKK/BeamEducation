...
public class Class5Test extends BaseTest{
	...
	@Test(priority=1,  dataProvider = "Beam", dataProviderClass = Class5ExcelData.class)
	public void addcase(String cases, String composingsentenses, String structuraldevices, 
			String developingparagraphs, String creatingnarrativeness, String Purpose,
			String Punctuation, String Tenses,String joinedupwritting,String prefixesandsuffixes, 
			String spellinglists,String timeandcause,  String expectedresults) throws InterruptedException, IOException
	{ 
		page.click(class5);
		page.click(addWritingAssesment);
		page.click("//span[text()='Composing Sentences']");
		page.click(scroll);
		page.click(composingsentenses);
		Thread.sleep(500);
		...
		Thread.sleep(500);
         ...
         try {
             ...
             Sheet sheet = workbook.getSheet("Class5");
